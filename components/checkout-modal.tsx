...
export function CheckoutModal({ isOpen, onClose }: CheckoutModalProps) {
  ...
  function handleClose() {
    onClose()
    // Delay reset to let exit animation finish
    setTimeout(() => {
      setOrderId(null)
      setServerError(null)
      reset()
                ...
                >
                  ...
                  <div className="border-b border-border/50 bg-card/30 p-6 md:border-b-0 md:border-r">
                    ...
                    {hasUnlinkedItems && (
                      <p className="mt-3 text-xs text-yellow-500/80">
                        Algunos productos del carrito no pueden procesarse.
                        Volvé a agregarlos desde el menú.
                      </p>
                    )}
                  ...
                  <div className="p-6">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
                      ...
                      <Field label="Notas del pedido" error={errors.notes?.message}>
                        <textarea
                          {...register('notes')}
                          rows={2}
